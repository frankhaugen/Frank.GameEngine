...
public class InputManager
{
    ...
    {
        _globalHook.MouseMoved += (sender, args) => callback(MouseDataConverter.ConvertTo(args.Data, args.EventTime));
    }

    public void OnMouseClick(Action<MouseChangeEventArgs> callback)
    {
        _globalHook.MouseClicked += (sender, args) => callback(MouseDataConverter.ConvertTo(args.Data, args.EventTime));
    }

    public void OnMouseScroll(Action<MouseChangeEventArgs> callback)
    {
        _globalHook.MouseWheel += (sender, args) => callback(MouseDataConverter.ConvertTo(args.Data, args.EventTime));
    }

    public void OnMouseDrag(Action<MouseChangeEventArgs> callback)
    {
        _globalHook.MouseDragged += (sender, args) => callback(MouseDataConverter.ConvertTo(args.Data, args.EventTime));
    }

    public void OnMousePressed(Action<MouseChangeEventArgs> callback)
    {
        _globalHook.MousePressed += (sender, args) => callback(MouseDataConverter.ConvertTo(args.Data, args.EventTime));
    }

    public void OnMouseReleased(Action<MouseChangeEventArgs> callback)
    {
        _globalHook.MouseReleased +=
    ...
    {
        _globalHook.KeyPressed += (sender, args) =>
    ...
    {
        _globalHook.KeyReleased += (sender, args) =>
    ...
    {
        _globalHook.KeyTyped += (sender, args) =>
