...
public static class GameObjectExtensions
{
    ...
    /// <returns>
    ///     Returns null if the game objects are not colliding. Otherwise, returns a collision object with the location of the
    ///     collision, the two game objects involved in the collision, and the force of the collision.
    /// </returns>
    ...
    /// <returns></returns>
    public static IEnumerable<Collision> GetCollisions(this GameObject gameObject,
        IEnumerable<GameObject> otherGameObjects)
    {
