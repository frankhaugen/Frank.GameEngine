...
public struct Fluid
{
    ...
    private static readonly Dictionary<FluidName, float> Densities = new()
    {
    ...
    private static readonly Dictionary<FluidName, float> Viscosities = new()
    {
    ...
    public static float GetDensity(FluidName fluid)
    {
        return Densities[fluid];
    }

    public static float GetViscosity(FluidName fluid)
    {
        return Densities[fluid];
    }
}