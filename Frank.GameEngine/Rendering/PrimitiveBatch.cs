...
public class PrimitiveBatch : IDisposable, IPrimitiveBatch
{
    ...
    public PrimitiveBatch(Microsoft.Xna.Framework.Graphics.GraphicsDevice graphicsDevice)
    {
    ...
    public void AddPolygon(IPolygon polygon) => AddPolygon(polygon, Color.White);
    
    public void AddPolygon(IPolygon polygon, Color color)
    {
    ...
    public void AddVertex(Vertex vertex) => AddVertex(vertex, Color.White);

    public void AddVertex(VertexColor vertexColor) => AddVertex(vertexColor.Vertex, vertexColor.Color);
    ...
    public void AddVertex(Vertex vertex, Color color)
    {
        ...
        _vertices[positionInBuffer].Position = vertex;
